...
$requiredFiles = [
    ...
    'docs/evidence/v0.3.0-development-baseline.md',
    'docs/evidence/v0.3.0-development-baseline.json',
    'docs/evidence/0.4-duplication-and-complexity-inventory.md',
    'docs/evidence/0.4-duplication-and-complexity-inventory.json',
    'docs/evidence/0.4-contract-freeze.md',
    'docs/evidence/0.4-performance-and-stability.md',
